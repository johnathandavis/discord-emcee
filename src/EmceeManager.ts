...
import type { EmceeUserInterface, StateDefinition, StateValue, StateInput, InputUpdateArgs, StateValueMap } from "./Shared";
...
class EmceeManager<T extends MCSchema<MCRawShape>> {
    ...
    private _latestInteraction: ButtonInteraction | StringSelectMenuInteraction | undefined = undefined;
    private readonly _schema: T;
    private readonly _state: State;
    private readonly ui: EmceeUserInterface;
    private readonly _validator: (s: Infer<T>) => boolean;

    constructor(schema: T, uiOptions: EmceeUserInterface, validator: (s: Infer<T>) => boolean) {
        this.ui = uiOptions;
        this._schema = schema;
